...
@section('content')
    <div class="text-center bg-gray-100 border-2 border-black py-8 mb-1">
        <h1 class="font-serif font-bold">De Gouden Draak is eenvoudig te vinden, vlak bij het centrum, 5 minuten lopen achter het centraal station.<br><br>
        Onderwijsboulevard 215, kamer OG112<br>
        5223 DE 's-Hertogenbosch</h1>
    </div>        

...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
			...
			<tbody>
                <tr style="height:50px;background-color:red"> 
                    <td style="text-align:center;width:30%;color:yellow;font-size:30px">
                            <img style="vertical-align: middle; height:50px" src="images/dragon-small.png" alt="Golden Dragon">
                            <span style="font-family:'chinese_takeawayregular'">De Gouden Draak</span>
                            <img style="vertical-align: middle; height:50px" src="images/dragon-small-flipped.png" alt="Golden Dragon">
                    </td>
                    <td>
		...
		<table id="main_table" style="padding:5px;width:100%;border-collapse: collapse">
			<tbody><tr style="height:7px;background-color:red">
				<td colspan="9">
				</td>
			</tr><tr>
			</tr><tr style="height:25px;background-color:red">
				<td width="7px">
				</td>
			...
			<tr style="height:25px;background-color:red">
				<td width="7px">
				</td><td style="width:25px;border-left:4px solid yellow;border-bottom:4px solid yellow"></td>
			...
			<tr style="height:25px;background-color:red">
				<td width="7px">
				</td><td style="width:25px;border-right:4px solid yellow;border-bottom:4px solid yellow"></td>
				<td style="width:25px;border:4px solid yellow"></td>
			...
			<tr style="height:50px;background-color:red"> 
				<td width="7px">
				</td><td style="width:25px;border-right:4px solid yellow;border-left:4px solid yellow"></td>
				<td style="width:25px;"></td>
				<td style="width:25px;"></td>
					...
					<table width="100%">
						<tbody><tr>
							<td colspan="3">
								...
								<p>
									</p><table style="margin:auto;font-size:20px;color:white" border="1px solid white">
										<tbody><tr background="pictures/menu_bg_gradient.png">
											<td valign="middle">
			...
			<tr style="height:25px;background-color:red">
				<td width="7px">
				</td><td style="width:25px;border-right:4px solid yellow;border-top:4px solid yellow"></td>
				<td style="width:25px;border:4px solid yellow"></td>
				<td style="width:25px"></td>
				<td></td>
				<td style="width:25px"></td>
			...
			<tr style="height:25px;background-color:red">
				<td width="7px">
				</td><td style="width:25px;border-left:4px solid yellow;border-top:4px solid yellow"></td>
				<td style="width:25px;border:4px solid yellow"></td>
				<td style="width:25px;border:4px solid yellow"></td>
				<td></td>
				<td style="width:25px;border:4px solid yellow"></td>
